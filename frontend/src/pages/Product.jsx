  ...
  return productData ? (
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 p-6 text-sm text-gray-500">
          <p>E-commerce, or electronic commerce, is the buying and selling of goods, services, or data, and the transfer of funds over the internet, primarily using computers and mobile devices. It operates 24/7, enabling businesses to reduce overhead while reaching global markets, with models including B2B, B2C, C2C, and C2B</p>
